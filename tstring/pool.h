#ifndef __tinfra_pool_h__
#define __tinfra_pool_h__
...
public:
    ...
    T* construct(V1 const& p1, V2 const& p2)
    {
        T* r = alloc();
        if( r ) {
            new(r) T(p1, p2);
...
typedef pool<char> byte_pool;
} //end namespace tinfra

#endif // __tinfra_pool_h__
